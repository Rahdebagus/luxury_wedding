<div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true" data-kt-drawer-name="app-sidebar"
    ...
    <div id="kt_app_sidebar_menu" data-kt-menu="true"
        ...
        <div id="kt_app_sidebar_menu_wrapper" class="hover-scroll-y px-1 px-lg-5" data-kt-sticky="true"
            ...
            <div class="menu-item">
                <a class="menu-link {{ request()->routeIs('flower.*') ? 'active' : '' }}"
                    href="{{ route('flower.index') }}">
                    <span class="menu-bullet">
                        <span class="bullet bullet-dot"></span>
                    </span>
                    <span class="menu-title">List Flower</span>
                </a>
            </div>
            <div class="menu-item">
                <a class="menu-link {{ request()->routeIs('addon.*') ? 'active' : '' }}"
                    href="{{ route('addon.index') }}">
                    <span class="menu-bullet">
                        <span class="bullet bullet-dot"></span>
                    </span>
                    <span class="menu-title">List addon</span>
                </a>
            </div>
            <div class="menu-item">
                <a class="menu-link {{ request()->routeIs('addon_flower.*') ? 'active' : '' }}"
                    href="{{ route('addon_flower.index') }}">
                    <span class="menu-bullet">
                        <span class="bullet bullet-dot"></span>
                    </span>
                    <span class="menu-title">List addon_flower</span>
                </a>
            </div>
            {{--  <div class="menu-item">
